...
def main():
    print("=" * 60)
    print("🧪 Training Module — Test Suite")
    print("=" * 60)
    print()
    ...
    total += 1
    if run_test("Aggiunta esempio", test_add_example): passed += 1
    ...
    total += 1
    if run_test("Aggiunta batch", test_add_batch): passed += 1
    ...
    total += 1
    if run_test("Training", test_train): passed += 1
    ...
    total += 1
    if run_test("Valutazione", test_evaluate): passed += 1
    ...
    total += 1
    if run_test("Feedback", test_feedback): passed += 1
    ...
    total += 1
    if run_test("Esportazione", test_export): passed += 1
    ...
    total += 1
    if run_test("Importazione", test_import): passed += 1
    ...
    total += 1
    if run_test("Statistiche", test_stats): passed += 1
