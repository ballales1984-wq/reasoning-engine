...
class TestMultiAgent(unittest.TestCase):
    ...
    def test_01_multi_agent_flow(self):
        ...
        query = "Chi e l'attuale CEO di Apple?"
        ...
        print("[OK] Flusso Multi-Agent confermato per tutti i ruoli.")
        print(f"[RISPOSTA] {res.answer[:100]}...")
        if "[Critica AI:" in res.explanation:
            print("[CRITICA] Feedback del Critico rilevato nella spiegazione.")
